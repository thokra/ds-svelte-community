<script lang="ts" context="module">
	import HStack from "$lib/components/primitives/Stack/HStack.svelte";
	import type { StackProps } from "$lib/components/primitives/Stack/type";
